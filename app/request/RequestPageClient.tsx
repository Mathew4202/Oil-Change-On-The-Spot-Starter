          ...
          <div className="flex items-start justify-between gap-4 flex-wrap">
            <div className="text-slate-700 space-y-1">
              ...
              {quote.discount > 0 && (
                <div className="text-sm text-green-600">
                  Christmas promo: -${quote.discount.toFixed(2)}
                </div>
              )}
            </div>
            ...
            <div className="text-right">
              ...
              {quote.discountActive && (
                <div className="text-xs text-green-600 mt-1">Christmas promo: $10 off applied</div>
              )}
            </div>
          </div>
        </div>
          ...
          <div>
            ...
            {f.postal && CA_POSTAL_RE.test(f.postal) && f.outOfArea && (
              <div className="mt-2 rounded-md border border-amber-300 bg-amber-50 px-3 py-2 text-amber-900">
                Outside of service area. We will see what we can do.
              </div>
            )}
          </div>
